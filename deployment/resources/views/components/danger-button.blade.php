@props(['variant' => 'danger', 'size' => 'md', 'disabled' => false])
...
$variants = [
    ...
    'outline' => 'border-2 border-red-600 text-red-600 dark:text-red-400 hover:bg-red-600 hover:text-white dark:hover:text-white focus:ring-red-500',
    'ghost' => 'text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 hover:text-red-700 dark:hover:text-red-300 focus:ring-red-500',
];
