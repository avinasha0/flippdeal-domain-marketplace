    ...
    <div class="card-body">
                            ...
                            <tr>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-sm bg-success rounded-circle d-flex align-items-center justify-content-center me-2">
                                            <span class="text-white fw-bold">
                                                {{ substr($conversation->seller->name ?? 'U', 0, 1) }}
                                            </span>
                                        </div>
                                        <div>
                                            <div class="fw-medium">{{ $conversation->seller->name ?? 'Unknown' }}</div>
                                            <small class="text-muted">{{ $conversation->seller->email ?? '' }}</small>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    @if($conversation->buyer_unread_count > 0)
                                        <span class="badge bg-danger">{{ $conversation->buyer_unread_count }}</span>
                                    @else
        ...
        @else
            <div class="text-center py-4">
                ...
                <p class="text-muted">You don't have any conversations with sellers yet.</p>
            </div>
        @endif
    </div>
</div>
