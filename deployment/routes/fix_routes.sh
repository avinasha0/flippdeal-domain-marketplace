...
# Create the updated routes file
...
Route::get('/conversations', function () { return view('conversations.index'); })->name('conversations.index');
...
Route::get('/offers', function () { return view('offers.index'); })->name('offers.index');
...
Route::get('/watchlist', function () { return view('watchlist.index'); })->name('watchlist.index');
